...
dt <- genData(500,def)
# scale's info:
# MDD: 3 items, scale (0~6)
# QL: 3 items, range (0~10)
# SQ: 4 items, range (0~8)
...
dt <- addCorData(dt, "ID", mu = mu3, sigma = sigma2, rho = .9, corstr = "cs")
dt <- addCorData(dt, "ID", mu = mu2, sigma = sigma2, rho = .9, corstr = "cs")
...
psych::describe(dt)
# not sure how to specify the scale range
dt <- dt %>%
  filter(QL1 > 0 & SQ1 > 0 & QL3 > 0 & SQ2 > 0 & SQ3 > 0 & SQ4 > 0) %>%
  filter(QL1 < 11 & QL2 <11 & QL3 < 11 & SQ2 < 9)
