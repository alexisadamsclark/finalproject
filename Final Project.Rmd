...
ggplot(data_p, aes(x = sq_total, y = mdd_total)) + 
  ...
  theme_minimal() + 
  labs(title = "The Association between Sleep Quality and Depression in Low SES Individuals",
       x = "Sleep Quality", 
       y = "Depression")
...
ggplot(data_p, aes(x = sq_total, y = ql_total)) + 
  ...
  geom_smooth(method = "lm") +
  theme_minimal() + 
  labs(title = "The Asssociation between Sleep Quality and Quality of Life in Low SES Individuals",
       x = "Sleep Quality", 
       y = "Quality of Life")
...
ggplot(data_p, aes(x =ql_total, y = mdd_total)) + 
  ...
  geom_smooth(method = "lm") +
  theme_minimal() + 
  labs(title = "The Association between Quality of Life and Depression in Low SES Individuals",
       x = "Quality of Life", 
       y = "Depression")
...
#Corrlation values with p-values
