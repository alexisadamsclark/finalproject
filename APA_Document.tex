...
and quality of life in a high risk sample. We also looked for
differences in depressive symptoms, sleep quality, and quality of life
according to socioeconomic status. Using correlational analyses, we
...
correlated with quality of life. However, there seemed to be no
observable differences between depressive symptoms, sleep quality, and
quality of life scores between socioeconomic groups. These results
indicate that intricate and strong associations exist among depressive
symptoms, sleep quality, and quality of life. Clinical implications of
...
Boden-Albala, \& Heymsfield, 2005). Additional research suggests that
the relationship between poor sleep quality and negative health outcomes
outcomes is exacerbated further due to the effects of poverty (i.e., low
SES) (Mezick et al., 2008). Perhaps, these populations could be
differentially affected by poor sleep quality, or be more vulnerable to
developing these maladaptive patterns.

Recent epidemiological research suggests that sleep has continued to
decrease over the past 30 years, which is consistent with the
significant increase in sleep-related complaints in the workforce
...
Müller, 2018), \emph{dplyr} (Version 0.7.7; Wickham, François, Henry, \&
Müller, 2018), \emph{forcats} (Version 0.3.0; Wickham, 2018a),
\emph{Formula} (Version 1.2.2; Zeileis \& Croissant, 2010),
\emph{ggplot2} (Version 3.0.0; Wickham, 2016), \emph{gridExtra} (Version
2.3; Auguie, 2017), \emph{here} (Version 0.1; Müller, 2017),
\emph{Hmisc} (Version 4.0.3; Harrell Jr, Charles Dupont, \& others.,
...
Francois, 2017), \emph{rio} (Version 0.5.5; C.-h. Chan, Chan, Leeper, \&
...
\hypertarget{ref-mezick2008influence}{}
Mezick, E. J., Matthews, K. A., Hall, M., Strollo Jr, P. J., Buysse, D.
J., Kamarck, T. W., \ldots{} Reis, S. E. (2008). Influence of race and
socioeconomic status on sleep: Pittsburgh sleep score project.
\emph{Psychosomatic Medicine}, \emph{70}(4), 410.
