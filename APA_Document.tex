...
\hypersetup{unicode=true,
            pdftitle={Final Project: The Relationships between Sleep, Depression, Quality of Life, and Socioeconomic Status},
            pdfauthor={Alexis Adams-Clark, Andrew Fridman, \& Xi Yang},
            pdfkeywords={sleep, depression, quality of life},
            pdfborder={0 0 0},
            breaklinks=true}
...
\def\footnote{\protect\rmarkdownfootnote}
  ...
  \title{Final Project: The Relationships between Sleep, Depression, Quality of
...
introducing us to Papaja and our classmates in Introduction to Data
Science with R.
...
participants chose to do so. The University's Office of Research
Compliance (Institutional Review Board) approved this study.
...
\subsubsection{Depression Scale}\label{depression-scale}
