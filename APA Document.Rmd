...
ggplot(scorebyses, aes(x = SES, y = `Mean Depression Score`, fill = SES)) + 
  geom_col(alpha = 0.7, width = 0.5) + 
  labs(title = "Mean Depression Score by Socioeconomic Status", 
...
ggplot(scorebyses, aes(x = SES, y = `Mean Sleep Quality Score`, fill = SES)) + 
  geom_col(alpha = 0.7, width = 0.5) + 
  labs(title = "Mean Sleep Quality Score by Socioeconomic Status", 
       y = "Sleep Quality Total Score", 
       x = "Socioeconomic Status") + 
       guides(fill=FALSE)
```
