...
The relationships between these depressive symptoms, sleep quality, and quality of life scores in low SES individuals are displayed in Figure 2. 
...
data_corr <- data_corr%>% 
  rename(`Mean Depression Score` = mdd_total,
         `Mean Sleep Quality Score` = sq_total,
         `Mean Quality of Life Score` = ql_total)
